    ...
    editor.on('instanceReady', function () {
      ...
      var itemsArray = [
        ...
        },
        {
          id: 648,
          name:
            'Delete columns work incorrectly with native selection on Chrome',
          type: 'bug',
        },
        {
          id: 740,
        ...
        },
        {
          id: 859,
          name:
            'Double-click on link opens empty link dialog due to bug in getSelectedLink',
          type: 'bug',
        },
        {
          id: 932,
      ...
      config.itemTemplate =
        '<li data-id="{id}" class="issue-{type}">#{id}: {name}</li>';
      config.outputTemplate =
        '<a href="https://github.com/ckeditor/ckeditor4/issues/{id}">{name} (#{id})</a> ';
